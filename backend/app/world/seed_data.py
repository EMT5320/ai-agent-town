...
AGENTS = [
    {"id": "mira", "name": "米娅", "genderIdentity": "female", "age": 31, "lifeStage": "adult", "job": "杂货铺店主", "locationId": "shop", "homeId": "home-north", "personality": ["务实", "照顾型", "轻微焦虑"], "familyId": "family-mira", "spouseId": "tomas", "childrenIds": ["nina"], "longTermGoals": ["让杂货铺稳定盈利", "照顾刚出生的孩子"], "money": 72, "health": 84},
    {"id": "tomas", "name": "托玛", "genderIdentity": "male", "age": 34, "lifeStage": "adult", "job": "木匠", "locationId": "home-north", "homeId": "home-north", "personality": ["可靠", "沉默", "保护欲强"], "familyId": "family-mira", "spouseId": "mira", "childrenIds": ["nina"], "longTermGoals": ["修缮小镇公共设施", "成为更好的父亲"], "money": 51, "health": 88},
    ...
    {"id": "lena", "name": "莉娜", "genderIdentity": "female", "age": 27, "lifeStage": "adult", "job": "医生", "locationId": "clinic", "homeId": "home-north", "personality": ["理性", "共情", "疲惫"], "familyId": "family-lena", "childrenIds": [], "longTermGoals": ["降低老人死亡风险", "建立公共健康档案"], "money": 64, "health": 82},
    ...
    {"id": "bram", "name": "布兰娜", "genderIdentity": "female", "age": 36, "lifeStage": "adult", "job": "农场主", "locationId": "shop", "homeId": "home-north", "personality": ["勤劳", "直率", "记仇", "强势"], "familyId": "family-bram", "childrenIds": [], "longTermGoals": ["稳定农田供应", "化解和酒馆的欠账冲突"], "money": 44, "health": 78},
]
